...
function SkillCard({ skill }: { skill: HardwareSkill }) {
  return (
...
export default function HardwareTechnicalTalentOverview({
  domain,
}: Props) {
  ...
  return (
    <div className="space-y-6">
      ...
      <Section
        ...
        description="The Hardware / Embedded role taxonomy represented in Atlas."
      >
      ...
      {/* Skills */}
      <Section
        title="Hardware / Embedded Skills"
        description="Core engineering capabilities and their relationships to roles and technologies."
      >
      ...
      {/* Technologies */}
      <Section
        title="Hardware / Embedded Technologies"
        description="Languages, operating systems, processors, interfaces, debugging tools, and engineering platforms."
      >
        <div className="grid gap-4 lg:grid-cols-2">
      ...
      {/* Research Landscape */}
      <Section
        title="Research & Engineering Landscape"
        description="Research, publication, conference, patent, and open-source signals useful for technical sourcing."
      >
        <div className="space-y-6">
          <div>
            <div className="mb-2 text-xs font-semibold uppercase tracking-wide text-muted-foreground">
      ...
      <Section
        ...
        description="Ready-to-use sourcing queries for common Hardware / Embedded searches."
      >
      ...
      <Section
        ...
        description="External technical ecosystems that can support deeper Hardware / Embedded talent research."
      >
